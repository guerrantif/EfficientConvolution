...
int main(int argc, char const *argv[]){
    ...
    Tensor<DType>* kernel1 = new Kernel<DType>(height, width, nChannels, nElements, tensor::init::INCR);
    ...
    std::cout << kernel1->at(0, 0, 0, 0) << std::endl;
    ...
    // Tensor<DType> image{7,7, 3,tensor::init::INCR};  // H, W, C
